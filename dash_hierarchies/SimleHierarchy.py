...
class SimleHierarchy(Component):
...
- data (list of dicts; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'colors', 'data', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'colors', 'data', 'style']
        ...
        super(SimleHierarchy, self).__init__(**args)
